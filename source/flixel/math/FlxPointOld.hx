...
class FlxPointOld implements IFlxPooled
{
	public static var pool(get, never):IFlxPool<FlxPointOld>;

	static var _pool:FlxPool<FlxPointOld> = new FlxPool<FlxPointOld>(FlxPointOld);

	/**
	 * Recycle or create a new FlxPointOld.
	 ...
	 * @return	This point.
	 */
	public static inline function get(X:Float = 0, Y:Float = 0):FlxPointOld
	{
	...
	/**
	 * Recycle or create a new FlxPointOld which will automatically be released
	 ...
	 * @return	This point.
	 */
	public static inline function weak(X:Float = 0, Y:Float = 0):FlxPointOld
	{
		var point = get(X, Y);
		point._weak = true;
		return point;
	...
	/**
	 * Add this FlxPointOld to the recycling pool.
	 */
	...
	/**
	 * Add this FlxPointOld to the recycling pool if it's a weak reference (allocated via weak()).
	 */
	 ...
	 * @return	This point.
	 */
	public function set(X:Float = 0, Y:Float = 0):FlxPointOld
	{
		x = X;
		y = Y;
		return this;
	 ...
	 * @return	This point.
	 */
	public inline function add(X:Float = 0, Y:Float = 0):FlxPointOld
	{
		x += X;
		y += Y;
		return this;
	 ...
	 * @return	This point.
	 */
	public function addPoint(point:FlxPointOld):FlxPointOld
	{
		addPointWeak(point);
		point.putWeak();
		return this;
	 ...
	 * @return	This point.
	 */
	inline function addPointWeak(point:FlxPointOld):FlxPointOld
	{
		x += point.x;
		y += point.y;
		return this;
	 ...
	 * @return	This point.
	 */
	public inline function subtract(X:Float = 0, Y:Float = 0):FlxPointOld
	{
		x -= X;
		y -= Y;
		return this;
	 ...
	 * @return	This point.
	 */
	public function subtractPoint(point:FlxPointOld):FlxPointOld
	{
	 ...
	 * @return	This point.
	 */
	inline function subtractPointWeak(point:FlxPointOld):FlxPointOld
	{
		x -= point.x;
		y -= point.y;
		return this;
	 ...
	 * @since   4.1.0
	 */
	public function scale(k:Float):FlxPointOld
	{
		x *= k;
		y *= k;
		return this;
	 ...
	 *
	 * @param	point	Any FlxPointOld.
	 * @return	A reference to itself.
	 */
	public inline function copyFrom(point:FlxPointOld):FlxPointOld
	{
		x = point.x;
		y = point.y;
		point.putWeak();
	 ...
	 */
	public function copyTo(?point:FlxPointOld):FlxPointOld
	{
		if (point == null)
		{
			point = FlxPointOld.get();
		}
		point.x = x;
		point.y = y;
		return point;
	 ...
	 * @return	A reference to itself.
	 */
	public inline function copyFromFlash(FlashPoint:Point):FlxPointOld
	{
		x = FlashPoint.x;
		y = FlashPoint.y;
		return this;
	 ...
	 *
	 * @param 	AnotherPoint	A FlxPointOld object to calculate the distance to.
	 * @return	The distance between the two points as a Float.
	 */
	public function distanceTo(point:FlxPointOld):Float
	{
	 ...
	 */
	public inline function floor():FlxPointOld
	{
		x = Math.floor(x);
		y = Math.floor(y);
		return this;
	 ...
	 */
	public inline function ceil():FlxPointOld
	{
		x = Math.ceil(x);
		y = Math.ceil(y);
		return this;
	 ...
	 */
	public inline function round():FlxPointOld
	{
		x = Math.round(x);
		y = Math.round(y);
		return this;
	 ...
	 * @return  A FlxPointOld containing the coordinates of the rotated point.
	 */
	public function rotate(Pivot:FlxPointOld, Angle:Float):FlxPointOld
	{
	 ...
	 */
	public function angleBetween(point:FlxPointOld):Float
	{
	...
	/**
	 * Function to get a `FlxVector` from this `FlxPointOld`
	 * @since 4.3.0
	 */
	@:deprecated("The `toVector` method is deprecated, FlxPointOlds can be casted to FlxVectors implicitly")
	...
	/**
	 * Function to compare this FlxPointOld to another.
	 *
	 * @param	point  The other FlxPointOld to compare to this one.
	 * @return	True if the FlxPointOlds have the same x and y value, false otherwise.
	 */
	public inline function equals(point:FlxPointOld):Bool
	{
	 ...
	 */
	public inline function transform(matrix:Matrix):FlxPointOld
	{
	...
	static function get_pool():IFlxPool<FlxPointOld>
	{
		return _pool;
	}
}
...
/**
 * A FlxPointOld that calls a function when set_x(), set_y() or set() is called. Used in FlxSpriteGroup.
 * IMPORTANT: Calling set(x, y); is MUCH FASTER than setting x and y separately. Needs to be destroyed unlike simple FlxPointOlds!
 */
class FlxCallbackPoint extends FlxPointOld
{
	var _setXCallback:FlxPointOld->Void;
	var _setYCallback:FlxPointOld->Void;
	var _setXYCallback:FlxPointOld->Void;
	 ...
	 */
	public function new(setXCallback:FlxPointOld->Void, ?setYCallback:FlxPointOld->Void, ?setXYCallback:FlxPointOld->Void)
	{
		super();
